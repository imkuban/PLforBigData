...
fun main() {
    ...
    try {
        ...
        // Ввод данных с консоли для поиска по наименованию и цене
        ...
        manager.listProductsByNameAndPrice(productName, maxPrice)
        println()

        // Ввод данных с консоли для поиска по сроку хранения
        println("Введите минимальный срок хранения:")
        val minShelfLife = scanner.nextInt()

        // Вывод списка товаров с сроком хранения больше заданного
        manager.listProductsByShelfLife(minShelfLife)
    } catch (e: InputMismatchException) {
        println("Ошибка ввода данных. Пожалуйста, введите корректные значения.")
    }
}